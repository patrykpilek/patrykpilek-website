...
<template>
    <div>
        ...
        <div class="py-6 px-4 sm:p-6 lg:pb-8">
            ...
            <div>
                <h2 class="text-lg leading-6 font-medium text-gray-900">Browser Sessions</h2>
            ...
            <div class="mt-8">
                ...
                <JetDialogModal :show="confirmingLogout" @close="closeModal">
                    ...
                    <template #footer>
                        ...
                        <JetButton
                            class="flex items-center justify-center ml-3 bg-gradient-to-r from-sky-400 to-blue-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:from-sky-700 hover:to-blue-700"
